...
public class PocketBellEvent {
    ...
    /**
     * Generate {@link PocketBellEvent}
     *
     * @param code      The code
     */
    public PocketBellEvent(int code) {
        this.code = code;
    }
    /**
     * Generate {@link PocketBellEvent} for changing the mode
     *
     * @param code      The code
     * @param mode      The mode
     */
    public PocketBellEvent(int code, int mode) {
        this.code = code;       
        this.mode = mode;
    }
    /**
     * Generate {@link PocketBellEvent} for a inputing character
     *
     * @param code      The code
     * @param c         The inputing character
     */
    public PocketBellEvent(int code, char c) {
        this.code = code;       
        this.chars = new char[1];
        this.chars[0] = c;
     }
    /**
     * Generate {@link PocketBellEvent} for inputing characters
     *
     * @param code      The code
    ...
    /**
     * Generate {@link PocketBellEvent} for toggle inputing a character
     *
     * @param code          The code
     * @param toggleTable   The array of toggle inputing a character
     */
    public PocketBellEvent(int code, String[] toggleTable) {
        this.code = code;
        this.toggleTable = toggleTable;
    }
    /**
     * Generate {@link PocketBellEvent} for replacing a character
     *
     * @param code          The code
     * @param replaceTable  The replace table
     */
    public PocketBellEvent(int code, HashMap<?,?> replaceTable) {
        this.code = code;
        this.replaceTable = replaceTable;
    }
    /**
     * Generate {@link PocketBellEvent} from {@link KeyEvent}
     * <br>
     * This constructor is same as {@code OpenWnnEvent(INPUT_KEY, ev)}.
     *
     * @param ev    The key event
     */
    public PocketBellEvent(KeyEvent ev) {
     ...
     * @param ev        The key event
     */
    public PocketBellEvent(int code, KeyEvent ev) {
        this.code = code;
        this.keyEvent = ev;
    }
    /**
     * Generate {@link PocketBellEvent} for selecting a candidate
     *
     * @param code      The code
     * @param word      The selected candidate
     */
    public PocketBellEvent(int code, String word) {
        this.code = code;       
        this.word = word;
    }

    /**
     * Generate {@link PocketBellEvent} for dictionary management
     *
     * @param code      The code
     * @param dict      The type of dictionary
     * @param word      The selected candidate
     */
    public PocketBellEvent(int code, int dict, String word) {
        this.code = code;
